...
const GeneratePoster = () => {
  ...
  return (
    <div
      style={{
        height: '100vh',
        backgroundImage: "url('https://img.freepik.com/free-photo/blue-purple-background-with-gradient-sky-word-love-it_1340-36620.jpg')",
    ...
    >
      <header className="pt-5">
        <div
          ...
          style={{
            height: '30vh',
            backgroundImage: "url('https://cdn.shopify.com/s/files/1/0070/7032/files/best_20free_20background_20remover.jpg?v=1681162331')",
            backgroundRepeat: 'no-repeat',
            backgroundSize: '100%'
          }}
        >
          <h1 style={{ color: 'black', fontWeight: 'bolder', fontSize: '12vh' }}>Generate Poster</h1>
        </div>
      </header>
      <main>
        <div className="container pt-5">
          <div className="row">
            <div className="col-md-4">
              <div className="card">
                ...
                <div className="card-body">
                  <label className='btn btn-success'> <i class="fas fa-upload    "></i> Upload </label>
            ...
            <div className="col-md-4">
              <div className="card">
                ...
                <div className="card-body">
                  <select className="form-control" onChange={e => setSelVideo(e.target.value)}>
                    {videoList.map((video) => {
            ...
            <div className="col-md-4">
              <div className="card">
                ...
                <div className="card-body">
                  <select className="form-control" onChange={e => setSelImage(e.target.value)}>
                    {imageList.map((image) => {
          ...
          <button className='btn btn-danger w-100 mt-5' onClick={saveMarker}>Generate POSTER</button>
        </div>
      </main>
    </div>
  );
